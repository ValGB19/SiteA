...
public class Mein{
	           ...
	           if (jardin.getEnergiaJugador() >= 50) {
	        	   try {
			           ...
			           case 1:
			               ...
			               if (jardin.getEnergiaJugador() >= 50) {
			            	   juegaJugador(new Girasol(), jardin,jardin.getEnergiaJugador() - 50);
			               }else
			           ...
			           case 2:
			               ...
			               if (jardin.getEnergiaJugador() >= 100) {
			            	   juegaJugador(new Lanzaguisante(), jardin,jardin.getEnergiaJugador() - 100);
			               }else 
			            	   System.out.println("No tiene energia suficiente");
			               break;
			           case 3:
			               ...
			               if (jardin.getEnergiaJugador() >= 75) {
			            	   juegaJugador(new Nuez(), jardin,jardin.getEnergiaJugador() - 75);
			               }else
			            	   System.out.println("No tiene energia suficiente");
			               break;
			           default:
	...
	private static void juegaJugador(Personage x, Jardin jardin, int energy) {
       System.out.println("ingrese la posicion de la planta seleccionada");
   	   ...
   	   if(corroborar(posicionX, posicionY)){
   		   if (jardin.getMapa()[posicionX][posicionY] == null) {
	   		   ...
	   		   jardin.setEnergiaJugador(jardin.getEnergiaJugador()-energy);
	   		   jardin.avanzar();
	    	}
   	   }
	}
